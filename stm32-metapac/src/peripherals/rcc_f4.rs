...
# [inline (always)]
pub const fn ahb1rstr (self) -> crate :: common :: Reg < regs :: Ahb1rstr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (16usize) as _) } } # [doc = "AHB2 peripheral reset register"]
# [inline (always)]
pub const fn ahb2rstr (self) -> crate :: common :: Reg < regs :: Ahb2rstr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (20usize) as _) } } # [doc = "AHB3 peripheral reset register"]
# [inline (always)]
pub const fn ahb3rstr (self) -> crate :: common :: Reg < regs :: Ahb3rstr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (24usize) as _) } } # [doc = "APB1 peripheral reset register"]
# [inline (always)]
...
# [inline (always)]
pub const fn ahb1enr (self) -> crate :: common :: Reg < regs :: Ahb1enr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (48usize) as _) } } # [doc = "AHB2 peripheral clock enable register"]
# [inline (always)]
pub const fn ahb2enr (self) -> crate :: common :: Reg < regs :: Ahb2enr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (52usize) as _) } } # [doc = "AHB3 peripheral clock enable register"]
# [inline (always)]
pub const fn ahb3enr (self) -> crate :: common :: Reg < regs :: Ahb3enr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (56usize) as _) } } # [doc = "APB1 peripheral clock enable register"]
# [inline (always)]
...
# [inline (always)]
pub const fn ahb1lpenr (self) -> crate :: common :: Reg < regs :: Ahb1lpenr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (80usize) as _) } } # [doc = "AHB2 peripheral clock enable in low power mode register"]
# [inline (always)]
pub const fn ahb2lpenr (self) -> crate :: common :: Reg < regs :: Ahb2lpenr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (84usize) as _) } } # [doc = "AHB3 peripheral clock enable in low power mode register"]
# [inline (always)]
pub const fn ahb3lpenr (self) -> crate :: common :: Reg < regs :: Ahb3lpenr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (88usize) as _) } } # [doc = "APB1 peripheral clock enable in low power mode register"]
# [inline (always)]
...
# [inline (always)]
pub const fn sscgr (self) -> crate :: common :: Reg < regs :: Sscgr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (128usize) as _) } } # [doc = "PLLI2S configuration register"]
# [inline (always)]
pub const fn plli2scfgr (self) -> crate :: common :: Reg < regs :: Plli2scfgr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (132usize) as _) } } # [doc = "RCC PLL configuration register"]
# [inline (always)]
pub const fn pllsaicfgr (self) -> crate :: common :: Reg < regs :: Pllsaicfgr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (136usize) as _) } } # [doc = "RCC Dedicated Clock Configuration Register"]
# [inline (always)]
pub const fn dckcfgr (self) -> crate :: common :: Reg < regs :: Dckcfgr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (140usize) as _) } } # [doc = "Clocks gated enable register"]
# [inline (always)]
pub const fn ckgatenr (self) -> crate :: common :: Reg < regs :: Ckgatenr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (144usize) as _) } } # [doc = "DCKCFGR2 register"]
# [inline (always)]
...
LSE = 0 , # [doc = "HSI divided by 488 clock is selected as HDMI-CEC clock"]
...
I2S1 = 0 , # [doc = "CK_I2S_APB2 selected as audio clock"]
...
PCLK2 = 0 , # [doc = "System clock used as Kernel clock"]
...
PLL1_Q = 0 , # [doc = "48MHz clock from PLLSAI is selected"]
...
DSI_PHY = 0 , # [doc = "PLLR used as DSI byte lane clock source, used in case DSI PLL and DSI-PHY are off (low power mode)"]
...
PLLI2SR = 0 , # [doc = "I2Sx clock frequency = I2S_CKIN Alternate function input frequency"]
...
PLLI2S = 0 , # [doc = "External clock mapped on the I2S_CKIN pin used as I2S clock source"]
...
PLLI2S_R = 0 , # [doc = "clock frequency = I2S_CKIN Alternate function input frequency"]
...
LOW = 0 , # [doc = "LSE oscillator high drive mode selection"]
...
HSE_HSI = 0 , # [doc = "External AFI clock (CK_PLLI2S_EXT) selected as PLL clock entry"]
...
PLLSAI = 0 , # [doc = "SAI1 clock frequency = f(PLLI2S_Q) / PLLI2SDIVQ"]
...
PLLSAI = 0 , # [doc = "SAI2 clock frequency = f(PLLI2S_Q) / PLLI2SDIVQ"]
...
PLLSAI = 0 , # [doc = "SAI1-A clock frequency = f(PLLI2S_Q) / PLLI2SDIVQ"]
...
PLLSAI = 0 , # [doc = "SAI1-B clock frequency = f(PLLI2S_Q) / PLLI2SDIVQ"]
...
CLK48 = 0 , # [doc = "System clock is selected as SD clock"]
...
PLL1_R = 0 , # [doc = "SPDIF-Rx clock from PLLI2S is selected"]
