...
# [inline (always)]
pub const fn plli2scfgr (self) -> crate :: common :: Reg < regs :: Plli2scfgr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (132usize) as _) } } # [doc = "PLL configuration register"]
# [inline (always)]
pub const fn pllsaicfgr (self) -> crate :: common :: Reg < regs :: Pllsaicfgr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (136usize) as _) } } # [doc = "dedicated clocks configuration register"]
# [inline (always)]
pub const fn dckcfgr1 (self) -> crate :: common :: Reg < regs :: Dckcfgr1 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (140usize) as _) } } # [doc = "dedicated clocks configuration register"]
# [inline (always)]
pub const fn dckcfgr2 (self) -> crate :: common :: Reg < regs :: Dckcfgr2 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (144usize) as _) } } } pub mod regs { # [doc = "AHB1 peripheral clock register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
SAI1 = 0 , # [doc = "SAI2 clock selected as DFSDM1 Audio clock source"]
...
PCLK2 = 0 , # [doc = "System clock (SYSCLK) clock selected as DFSDM1 Kernel clock source"]
...
LOW = 0 , # [doc = "Medium high driving capability"]
...
PLLSAI1_Q = 0 , # [doc = "SAI2 clock frequency = f(PLLI2S_Q) / PLLI2SDIVQ"]
...
PCLK2 = 0 , # [doc = "System clock is selected as USART clock"]
...
PCLK1 = 0 , # [doc = "System clock is selected as USART clock"]
SYS = 0x01 , # [doc = "HSI clock is selected as USART clock"]
HSI = 0x02 , # [doc = "LSE clock is selected as USART clock"]
