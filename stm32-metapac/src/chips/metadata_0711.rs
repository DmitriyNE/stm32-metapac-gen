    ...
    DmaChannel {
        ...
        dmamux_channel: None,
            ...
            #[path="../registers/adc_40v1_U5.rs"] pub mod adc;
#[path="../registers/adccommon_40v1_U5.rs"] pub mod adccommon;
#[path="../registers/adf_v1.rs"] pub mod adf;
#[path="../registers/aes_u5.rs"] pub mod aes;
...
#[path="../registers/icache_v1.rs"] pub mod icache;
