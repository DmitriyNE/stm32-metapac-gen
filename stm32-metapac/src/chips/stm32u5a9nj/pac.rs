...
; } pub const UID : uid :: Uid = unsafe { uid :: Uid :: from_ptr (0x0bfa_0700 as usize as _) } ; pub const TIM2 : timer :: TimGp32 = unsafe { timer :: TimGp32 :: from_ptr (0x4000_0000 as usize as _) } ; pub const TIM3 : timer :: TimGp32 = unsafe { timer :: TimGp32 :: from_ptr (0x4000_0400 as usize as _) } ; pub const TIM4 : timer :: TimGp32 = unsafe { timer :: TimGp32 :: from_ptr (0x4000_0800 as usize as _) } ; pub const TIM5 : timer :: TimGp32 = unsafe { timer :: TimGp32 :: from_ptr (0x4000_0c00 as usize as _) } ; pub const TIM6 : timer :: TimBasic = unsafe { timer :: TimBasic :: from_ptr (0x4000_1000 as usize as _) } ; pub const TIM7 : timer :: TimBasic = unsafe { timer :: TimBasic :: from_ptr (0x4000_1400 as usize as _) } ; pub const WWDG : wwdg :: Wwdg = unsafe { wwdg :: Wwdg :: from_ptr (0x4000_2c00 as usize as _) } ; pub const IWDG : * mut () = 0x4000_3000 as usize as _ ; pub const SPI2 : spi :: Spi = unsafe { spi :: Spi :: from_ptr (0x4000_3800 as usize as _) } ; pub const USART2 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4000_4400 as usize as _) } ; pub const USART3 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4000_4800 as usize as _) } ; pub const UART4 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4000_4c00 as usize as _) } ; pub const UART5 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4000_5000 as usize as _) } ; pub const I2C1 : i2c :: I2c = unsafe { i2c :: I2c :: from_ptr (0x4000_5400 as usize as _) } ; pub const I2C2 : i2c :: I2c = unsafe { i2c :: I2c :: from_ptr (0x4000_5800 as usize as _) } ; pub const CRS : crs :: Crs = unsafe { crs :: Crs :: from_ptr (0x4000_6000 as usize as _) } ; pub const USART6 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4000_6400 as usize as _) } ; pub const I2C4 : i2c :: I2c = unsafe { i2c :: I2c :: from_ptr (0x4000_8400 as usize as _) } ; pub const LPTIM2 : * mut () = 0x4000_9400 as usize as _ ; pub const I2C5 : i2c :: I2c = unsafe { i2c :: I2c :: from_ptr (0x4000_9800 as usize as _) } ; pub const I2C6 : i2c :: I2c = unsafe { i2c :: I2c :: from_ptr (0x4000_9c00 as usize as _) } ; pub const FDCAN1 : can :: Fdcan = unsafe { can :: Fdcan :: from_ptr (0x4000_a400 as usize as _) } ; pub const FDCANRAM1 : fdcanram :: Fdcanram = unsafe { fdcanram :: Fdcanram :: from_ptr (0x4000_ac00 as usize as _) } ; pub const UCPD1 : ucpd :: Ucpd = unsafe { ucpd :: Ucpd :: from_ptr (0x4000_dc00 as usize as _) } ; pub const TIM1 : timer :: TimAdv = unsafe { timer :: TimAdv :: from_ptr (0x4001_2c00 as usize as _) } ; pub const SPI1 : spi :: Spi = unsafe { spi :: Spi :: from_ptr (0x4001_3000 as usize as _) } ; pub const TIM8 : timer :: TimAdv = unsafe { timer :: TimAdv :: from_ptr (0x4001_3400 as usize as _) } ; pub const USART1 : usart :: Usart = unsafe { usart :: Usart :: from_ptr (0x4001_3800 as usize as _) } ; pub const TIM15 : timer :: TimGp16 = unsafe { timer :: TimGp16 :: from_ptr (0x4001_4000 as usize as _) } ; pub const TIM16 : timer :: TimGp16 = unsafe { timer :: TimGp16 :: from_ptr (0x4001_4400 as usize as _) } ; pub const TIM17 : timer :: TimGp16 = unsafe { timer :: TimGp16 :: from_ptr (0x4001_4800 as usize as _) } ; pub const SAI1 : * mut () = 0x4001_5400 as usize as _ ; pub const SAI2 : * mut () = 0x4001_5800 as usize as _ ; pub const LTDC : ltdc :: Ltdc = unsafe { ltdc :: Ltdc :: from_ptr (0x4001_6800 as usize as _) } ; pub const GPDMA1 : gpdma :: Gpdma = unsafe { gpdma :: Gpdma :: from_ptr (0x4002_0000 as usize as _) } ; pub const CORDIC : cordic :: Cordic = unsafe { cordic :: Cordic :: from_ptr (0x4002_1000 as usize as _) } ; pub const FMAC : fmac :: Fmac = unsafe { fmac :: Fmac :: from_ptr (0x4002_1400 as usize as _) } ; pub const FLASH : flash :: Flash = unsafe { flash :: Flash :: from_ptr (0x4002_2000 as usize as _) } ; pub const CRC : crc :: Crc = unsafe { crc :: Crc :: from_ptr (0x4002_3000 as usize as _) } ; pub const TSC : tsc :: Tsc = unsafe { tsc :: Tsc :: from_ptr (0x4002_4000 as usize as _) } ; pub const MDF1 : * mut () = 0x4002_5000 as usize as _ ; pub const DMA2D : dma2d :: Dma2d = unsafe { dma2d :: Dma2d :: from_ptr (0x4002_b000 as usize as _) } ; pub const GFXMMU : gfxmmu :: Gfxmmu = unsafe { gfxmmu :: Gfxmmu :: from_ptr (0x4002_c000 as usize as _) } ; pub const GPU2D : * mut () = 0x4002_f000 as usize as _ ; pub const ICACHE : icache :: Icache = unsafe { icache :: Icache :: from_ptr (0x4003_0400 as usize as _) } ; pub const DCACHE1 : * mut () = 0x4003_1400 as usize as _ ; pub const DCACHE2 : * mut () = 0x4003_1800 as usize as _ ; pub const GPIOA : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x4202_0000 as usize as _) } ; pub const GPIOB : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x4202_0400 as usize as _) } ; pub const GPIOC : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x4202_0800 as usize as _) } ; pub const GPIOD : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x4202_0c00 as usize as _) } ; pub const GPIOE : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x4202_1000 as usize as _) } ; pub const GPIOF : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x4202_1400 as usize as _) } ; pub const GPIOG : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x4202_1800 as usize as _) } ; pub const GPIOH : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x4202_1c00 as usize as _) } ; pub const GPIOI : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x4202_2000 as usize as _) } ; pub const GPIOJ : gpio :: Gpio = unsafe { gpio :: Gpio :: from_ptr (0x4202_2400 as usize as _) } ; pub const ADC1 : * mut () = 0x4202_8000 as usize as _ ; pub const ADC2 : * mut () = 0x4202_8100 as usize as _ ; pub const ADC_COMMON : adccommon :: AdcCommon = unsafe { adccommon :: AdcCommon :: from_ptr (0x4202_8300 as usize as _) } ; pub const DCMI : dcmi :: Dcmi = unsafe { dcmi :: Dcmi :: from_ptr (0x4202_c000 as usize as _) } ; pub const PSSI : * mut () = 0x4202_c400 as usize as _ ; pub const USB_OTG_HS : otg :: Otg = unsafe { otg :: Otg :: from_ptr (0x4204_0000 as usize as _) } ; pub const AES : aes :: Aes = unsafe { aes :: Aes :: from_ptr (0x420c_0000 as usize as _) } ; pub const HASH : hash :: Hash = unsafe { hash :: Hash :: from_ptr (0x420c_0400 as usize as _) } ; pub const RNG : rng :: Rng = unsafe { rng :: Rng :: from_ptr (0x420c_0800 as usize as _) } ; pub const SAES : * mut () = 0x420c_0c00 as usize as _ ; pub const PKA : * mut () = 0x420c_2000 as usize as _ ; pub const OCTOSPIM : octospim :: Octospim = unsafe { octospim :: Octospim :: from_ptr (0x420c_4000 as usize as _) } ; pub const OTFDEC1 : * mut () = 0x420c_5000 as usize as _ ; pub const OTFDEC2 : * mut () = 0x420c_5400 as usize as _ ; pub const SDMMC1 : sdmmc :: Sdmmc = unsafe { sdmmc :: Sdmmc :: from_ptr (0x420c_8000 as usize as _) } ; pub const SDMMC2 : sdmmc :: Sdmmc = unsafe { sdmmc :: Sdmmc :: from_ptr (0x420c_8c00 as usize as _) } ; pub const OCTOSPI1 : octospi :: Octospi = unsafe { octospi :: Octospi :: from_ptr (0x420d_1400 as usize as _) } ; pub const SYSCFG : syscfg :: Syscfg = unsafe { syscfg :: Syscfg :: from_ptr (0x4600_0400 as usize as _) } ; pub const SPI3 : spi :: Spi = unsafe { spi :: Spi :: from_ptr (0x4600_2000 as usize as _) } ; pub const LPUART1 : usart :: Lpuart = unsafe { usart :: Lpuart :: from_ptr (0x4600_2400 as usize as _) } ; pub const I2C3 : i2c :: I2c = unsafe { i2c :: I2c :: from_ptr (0x4600_2800 as usize as _) } ; pub const LPTIM1 : * mut () = 0x4600_4400 as usize as _ ; pub const LPTIM3 : * mut () = 0x4600_4800 as usize as _ ; pub const LPTIM4 : * mut () = 0x4600_4c00 as usize as _ ; pub const OPAMP1 : * mut () = 0x4600_5000 as usize as _ ; pub const OPAMP2 : * mut () = 0x4600_5010 as usize as _ ; pub const COMP1 : * mut () = 0x4600_5400 as usize as _ ; pub const COMP2 : * mut () = 0x4600_5404 as usize as _ ; pub const VREFBUF : vrefbuf :: Vrefbuf = unsafe { vrefbuf :: Vrefbuf :: from_ptr (0x4600_7400 as usize as _) } ; pub const RTC : rtc :: Rtc = unsafe { rtc :: Rtc :: from_ptr (0x4600_7800 as usize as _) } ; pub const TAMP : tamp :: Tamp = unsafe { tamp :: Tamp :: from_ptr (0x4600_7c00 as usize as _) } ; pub const PWR : pwr :: Pwr = unsafe { pwr :: Pwr :: from_ptr (0x4602_0800 as usize as _) } ; pub const RCC : rcc :: Rcc = unsafe { rcc :: Rcc :: from_ptr (0x4602_0c00 as usize as _) } ; pub const ADC4 : * mut () = 0x4602_1000 as usize as _ ; pub const DAC1 : dac :: Dac = unsafe { dac :: Dac :: from_ptr (0x4602_1800 as usize as _) } ; pub const EXTI : exti :: Exti = unsafe { exti :: Exti :: from_ptr (0x4602_2000 as usize as _) } ; pub const ADF1 : adf :: Adf = unsafe { adf :: Adf :: from_ptr (0x4602_4000 as usize as _) } ; pub const LPDMA1 : * mut () = 0x4602_5000 as usize as _ ; pub const FMC : * mut () = 0x6000_0000 as usize as _ ; pub const OCTOSPI2 : octospi :: Octospi = unsafe { octospi :: Octospi :: from_ptr (0x7000_0000 as usize as _) } ; pub const HSPI1 : * mut () = 0xa000_0000 as usize as _ ; pub const DBGMCU : dbgmcu :: Dbgmcu = unsafe { dbgmcu :: Dbgmcu :: from_ptr (0xe004_4000 as usize as _) } ; # [doc = r" Number available in the NVIC for configuring priority"]
# [cfg (feature = "rt")]
...
pub use Interrupt as interrupt ;pub fn GPIO(n: usize) -> gpio::Gpio {
        ...
        }#[path="../../peripherals/adccommon_40v1_U5.rs"] pub mod adccommon;
#[path="../../peripherals/adf_v1.rs"] pub mod adf;
#[path="../../peripherals/aes_u5.rs"] pub mod aes;
...
#[path="../../peripherals/icache_v1.rs"] pub mod icache;
